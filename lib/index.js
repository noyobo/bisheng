...
exports.start = function start(program) {
  ...
  fs.writeFileSync(indexPath, nunjucks.renderString(template, {
    root: config.root,
    publicPath: config.publicPath || config.root,
  }));
  ...
  if (program.livereload) {
    doraConfig.plugins.push(require.resolve('@ali/dora-plugin-livereload-ice'));
  }
